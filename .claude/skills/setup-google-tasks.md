...
| Authorized redirect URIs | `https://agent-dock.replit.app/callback/google_tasks` | **必須完全一致** |
...
- 確認 Redirect URI 完全一致：`https://agent-dock.replit.app/callback/google_tasks`
