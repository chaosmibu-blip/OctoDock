...
2. 設定為：`https://agent-dock.replit.app/api/webhook/line`
3. 開啟 **Use webhook**
...
- LINE Adapter 原始碼：`src/adapters/line.ts`（5 個工具）
...
| 查詢 | `line_get_profile` | 取得用戶資料（名稱、頭像） |
| | `line_get_followers` | 取得粉絲數與統計 |
